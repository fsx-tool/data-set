...
TEST(test__ZN6Client3RunEv, test_3) {
    int stub_retval___errno_location_arr[1024]; // !test_3
    memset(stub_retval___errno_location_arr, 0, 1024 * sizeof(int)); // !test_3
    stub_retval___errno_location = (int *) &stub_retval___errno_location_arr[0]; // !test_3
    stub_retval_Extractor_canRead = 65536;
    stub_retval_connect = -1;
    stub_retval_socket = -1;
    stub_retval_bind = -1;
...
TEST(test__ZN6Client3RunEv, test_5) {
    stub_retval_Extractor_canRead = 1109660036;
    stub_retval_connect = -1;
    stub_retval_socket = -1;
    stub_retval_bind = -1;
    stub_retval_write = -9223372036854775808;
